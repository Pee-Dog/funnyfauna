...
public class BlockLogicFunnyStairsPainted extends BlockLogicStairs implements IPainted {
	private final Supplier<Block<?>> unpaintedVariant;

	public BlockLogicFunnyStairsPainted(Block<?> block, Block<?> modelBlock, Supplier<Block<?>> unpaintedVariant) {
