...
/**
 * Fix Issue 5: Allow idle behavior (looking around, hopping) during daytime perching,
 * but freeze completely at night.
 */
public class PerchTask<T extends MobTaskrunner & IFlyable> extends Task<T> {
	...
	protected Task onTick() {
		// Keep bird completely frozen
		mob.setMoveForward(0);

		// Freeze wing animation at night
//		if (isNight()) {
//			mob.setFlapSpeed(0);
//			mob.setFlapping(0);
//		}
