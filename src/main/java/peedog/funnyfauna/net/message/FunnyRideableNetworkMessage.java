package peedog.funnyfauna.net.message;
...
public class FunnyRideableNetworkMessage implements NetworkMessage {
	...
	public FunnyRideableNetworkMessage() {}

	public FunnyRideableNetworkMessage(float moveForward, float moveStrafe, boolean isJumping, float xRot, float yRot) {
	...
	public void handle(NetworkContext networkContext) {
		if (EnvironmentHelper.isServerEnvironment()) {
			...
			if (player.vehicle instanceof FunnyRideable) {
				FunnyRideable vehicle = (FunnyRideable) player.vehicle;
				vehicle.controlEntity(moveForward, moveStrafe, isJumping, xRot, yRot);
			}

			else if (player.passenger instanceof FunnyRideable) {
				FunnyRideable vehicle = (FunnyRideable) player.passenger;
				vehicle.controlEntity(moveForward, moveStrafe, isJumping, xRot, yRot);
			}
		}
	}
