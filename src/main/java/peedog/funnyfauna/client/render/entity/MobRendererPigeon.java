...
public class MobRendererPigeon extends MobRenderer<MobPigeon> {

	public MobRendererPigeon() {
		super(0.5F);
	}

	@Override
	protected @Nullable StaticEntityModel getAndSetupModelForLayer(
		@NonNull MobPigeon entity, float brightness, float partialTick, int layer) {
		...
		if (!(entity.onGround || entity.isPerched())) {
	...
	@Override
	protected int maxRenderLayer(@NonNull MobPigeon entity) {
		return 0; // no extra layers
	}

	@Override
	public void render(@NonNull Tessellator tessellator, @NonNull MobPigeon entity,
	...
	@Override
	public void postRender(@NonNull Tessellator tessellator, @NonNull MobPigeon entity,
						   double x, double y, double z, float yaw, float partialTick) {
