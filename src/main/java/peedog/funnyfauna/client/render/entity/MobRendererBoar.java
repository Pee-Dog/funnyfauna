...
public class MobRendererBoar extends MobRenderer<MobBoar> {
	public MobRendererBoar() {
		super(0.5F);
	}
	@Override
	protected @Nullable StaticEntityModel getAndSetupModelForLayer(@NonNull MobBoar entity, float brightness, float partialTick, int layer) {
