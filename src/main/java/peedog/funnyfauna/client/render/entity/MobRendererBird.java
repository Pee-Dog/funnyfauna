...
public class MobRendererBird extends MobRenderer<MobBird> {
	...
	protected @Nullable StaticEntityModel getAndSetupModelForLayer(
		@NonNull MobBird entity, float brightness, float partialTick, int layer) {
	...
	@Override
	public void render(@NonNull Tessellator tessellator, @NonNull MobBird entity,
	...
	@Override
	public void postRender(@NonNull Tessellator tessellator, @NonNull MobBird entity,
						   double x, double y, double z, float yaw, float partialTick) {
